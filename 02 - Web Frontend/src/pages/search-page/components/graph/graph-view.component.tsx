...
import { azServiceConfig } from "../../service/az";
...
class GraphView extends React.Component<GraphViewProps, GraphViewState> {
  constructor(props) {
    ...
    this.state = {
      graphApi: CreateGraphApi(azServiceConfig.graphConfig),
  ...
  private updateGraphApiAndDescriptor = (
    ...
    this.setState(
      {
        ...this.state,
        graphApi: CreateGraphApi(graphConfig || azServiceConfig.graphConfig)
      },
  ...
  public componentDidUpdate(
    ...
    prevState: GraphViewState
  ) {
    if (this.state.graphDescriptor != prevState.graphDescriptor) {
      loadGraph(
        containerId,
        this.state.graphDescriptor,
        this.props.onGraphNodeDblClick,
        this.props.theme
      );
    }
  }
